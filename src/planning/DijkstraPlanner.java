...
/**
 * Cette classe décrit un planificateur qui utilise l'algorithme de Dijsktra, permettant de faire de la recherche de chemin en fonction des coûts des actions dans
 * un graphe.
 */
public class DijkstraPlanner implements Planner {
    ...
    /**
     * Implémentation de l'algorithme de Dijkstra (généralisation de l'algorithme BFS).
    ...
    private List<Action> dijkstra(){
        ...
        while(open.size() != 0){ // tant qu'il reste des états ouvert
            Map<Variable, Object> instanciation = this.argmin(distance, open); // on prend l'état avec la plus petite distance
     ...
     * @param distance contient toutes les distances minimales pour arriver à chacun des noeuds visités
