...
public class DomainSizeVariableHeuristic implements VariableHeuristic {
     ...
     * {@code true}, c'est que l'on préfère que les variables aient le plus grand
     * domaine possible. S'il est à {@code false}, c'est que l'on préfère que les
     ...
     * est à {@code true}, c'est que l'on préfère que les variables aient le plus
     * grand domaine possible. S'il est à {@code false}, c'est que l'on préfère que
     * les variables aient le plus petit domaine possible.
     * 
     * @return booléen
     * @see #greatest
     */
